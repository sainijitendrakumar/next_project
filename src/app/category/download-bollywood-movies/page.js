...
export const metadata = {
  ...
  description:
    "Download Bollywood movies for free in HD—enjoy the latest Hindi films, dual-audio options, and fast downloads at SeeHDMovie.",
  keywords:
  ...
  canonical: "https://seehdmovie.xyz/category/download-bollywood-movies",
};
...
export default function Page() {
  return (
    ...
    <h1 className="font-bold font-sans text-2xl sm:text-3xl text-center text-red-600 my-4">
      Latest Bollywood Free HD Movie Download | Dual Audio Movies - SeeHDMovie
      </h1>
      <BollywoodMovies />
    </>
  );
