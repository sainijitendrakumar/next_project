...
export const metadata = {
    title: "Download Latest Hollywood HD Movies Free - SeeHDMovie",
  description: "Download the latest Hollywood movies in HD quality. Fast downloads, no registration required.",
  ...
  canonical:"https://seehdmovie.xyz/category/download_hollywood_movies"
}
...
export default function Page() {
  return (
    ...
    <h1 className="font-bold font-sans text-2xl sm:text-3xl text-center text-red-600 my-4">
      Latest Hollywood Free HD Movie Download | Dual Audio Movies - SeeHDMovie
      </h1>
      <Hollywood />
    </>
  );
